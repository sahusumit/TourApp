...
exports.showAlert = exports.hiddAlert = void 0;

var hiddAlert = function hiddAlert() {
  var el = document.querySelector('.alert');
  if (el) el.parentElement.removeChild(el);
};

exports.hiddAlert = hiddAlert;

var showAlert = function showAlert(type, msg) {
  var markup = "<div class =\"alert alert--".concat(type, "\">").concat(msg, "</div>");
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hiddAlert, 5000);
};
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:4001/api/v1/users/updatePassword' : 'http://localhost:4001/api/v1/users/updateData';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " update successfully"));
            }
...
var stripe = Stripe('pk_test_02IJlsY8AZAyZeDRFf60Ba4200QwsCtVIz');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:4001/api/v1/bookings/checkout-session/".concat(tourId));

          case 3:
            session = _context.sent;
            console.log(session); //2) Craete chekout from + charge credit card
